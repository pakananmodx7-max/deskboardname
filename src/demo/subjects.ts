...
export function buildInitialSubjectAssignments(studentIdsByClassroomIds: (classroomIds: string[]) => string[]): DemoSubjectAssignment[] {
  const scienceStudents = studentIdsByClassroomIds(['classroom-1', 'classroom-2'])
  ...
  return [
    {
      ...
      submissions: buildSubmissions(scienceStudents, 10, 1),
    },
    {
      id: 'sci-assign-2',
      subjectId: 'subject-science',
      ...
      submissions: buildSubmissions(scienceStudents, 10, 3),
    },
    {
      id: 'sci-assign-3',
      subjectId: 'subject-science',
      ...
      submissions: buildSubmissions(scienceStudents, 10, 5),
    },
    {
      id: 'sci-assign-4',
      subjectId: 'subject-science',
      ...
      submissions: buildSubmissions(scienceStudents, 10, 7),
    },
    {
      id: 'sci-assign-5',
      subjectId: 'subject-science',
      ...
      submissions: buildSubmissions(scienceStudents, 20, 2),
    },
    {
      id: 'sci-assign-6',
      subjectId: 'subject-science',
      ...
      submissions: buildSubmissions(scienceStudents, 30, 9),
    },
    {
      id: 'math-assign-1',
      subjectId: 'subject-math',
